...
/// 橘猫版 —— 同 CatRenderer 的姿态/动画，仅替换色板：
/// 身体橘黄、肚皮浅奶油、耳朵粉、尾巴深橘虎斑色
enum OrangeCatRenderer {

    // ── 色板（橘猫调）──
    private static let white     = CGColor(red: 1, green: 1, blue: 1, alpha: 1)
    private static let outline   = CGColor(red: 0.18, green: 0.10, blue: 0.05, alpha: 1)   // 深棕描边
    private static let bodyFill  = CGColor(red: 1.00, green: 0.62, blue: 0.20, alpha: 1)   // 橘黄
    private static let bellyFill = CGColor(red: 1.00, green: 0.92, blue: 0.78, alpha: 1)   // 浅奶油
    private static let pinkEar   = CGColor(red: 1.00, green: 0.55, blue: 0.62, alpha: 1)
    private static let pinkNose  = CGColor(red: 0.85, green: 0.42, blue: 0.30, alpha: 1)
    private static let pinkCheek = CGColor(red: 1.00, green: 0.55, blue: 0.50, alpha: 0.45)
    private static let pinkPad   = CGColor(red: 1.00, green: 0.65, blue: 0.62, alpha: 1)
    ...
    private static let tailGrey  = CGColor(red: 0.78, green: 0.45, blue: 0.18, alpha: 1)   // 深橘 (虎斑色)
